	...
	<body id="top">
		...
		<nav class="hide-on-small-only">
			<ul class="side-nav fixed section table-of-contents">
				...
				<li class="bold">
					<a aria-label="Open Régis&#39;s resume in a new tab" href="https://docs.google.com/document/d/1q43e84zGbdAFz29-ZtXReKTJbgrEDMYcNMQVVvaN8PI" target="_blank" class="waves-effect waves-dark grey-text"><i class="mdi-action-description small"></i><span><?php echo $large_nav_resume; ?></span></a>
				</li>
		...
		<nav class="hide-on-large only">
			<ul id="slide-out" class="side-nav" style="width: 190px; left: -200px;">
				...
				<li class="bold">
					<a aria-label="Open Régis&#39;s Resume in a new tab" href="https://docs.google.com/document/d/1q43e84zGbdAFz29-ZtXReKTJbgrEDMYcNMQVVvaN8PI" target="_blank" class="waves-effect waves-dark grey-text text-darken-3"><i class="mdi-action-description small"></i><span><?php echo $small_nav_resume; ?></span></a>
				</li>
